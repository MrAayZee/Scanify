"""
Scanify - Desktop PDF to Scanned Document Converter
...
class ScanifyApp(ctk.CTk, tkdnd.TkinterDnD.DnDWrapper):
    ...
    def __init__(self):
        ...
        # Window setup
        self.title("Scanify - Convert PDFs to Scanned Documents")
        ...
        try:
            ...
            if data:
                ...
                if self._compare_versions(latest_version, VERSION) > 0:
                    ...
                    self.after(0, lambda: self._show_update_notification(latest_version, download_url))
        except Exception as e:
    ...
    def _fetch_version_data(self):
        ...
        try:
            ...
            req.add_header('User-Agent', 'Scanify')
    ...
    def _show_update_notification(self, new_version, download_url):
        ...
        if messagebox.askyesno(
            "Update Available",
            f"A new version of Scanify is available!\n\nCurrent: {VERSION}\nLatest: {new_version}\n\nWould you like to download it?",
            icon='info'
        ):
            webbrowser.open(download_url)
    ...
    def _show_about(self):
        ...
        about_window.title("About Scanify")
        ...
        ctk.CTkLabel(
            content,
            text=f"© {datetime.now().year} Scanify\nReleased under MIT License",
